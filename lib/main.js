...
HkStockHoldingScraper.prototype.scrape = function($, callback) {
  ...
  var $resultInner_TableRows = $('#tbl_Result_inner > tr');
  // <!-- Shareholding date -->
  var $shareholdingDate = $resultInner_TableRows.eq(1);
  // <!-- code & name -->
  var $codeAndName = $resultInner_TableRows.eq(2);
  // <!-- *************  Search Result *************** -->
  // skip the first three rows
  var $searchResult = $resultInner_TableRows.eq(10).find('table').children().slice(3);
/*
  console.log("$resultInner_TableRows:");
  console.log($resultInner_TableRows.html());
  console.log("$shareholdingDate:");
  console.log($shareholdingDate.html());
  console.log("$codeAndName:");
  console.log($codeAndName.html());
...
//*/
  var result = {
    ...
    date: (function() {
        ...
        var match = $shareholdingDate.find('td').eq(2).text()
                      .trim().match(/(\d+)\/(\d+)\/(\d+)/);
        // console.log($shareholdingDate);
        // console.log(match);
        // NOTE: month-1 here
